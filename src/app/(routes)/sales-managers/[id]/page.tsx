...
export default function SalesManagersDetail({ params }: SalesManagersDetailProps) {
        ...
        return (
            <PageComponent>
                <div className="mx-auto w-8/12">
                    <SalesManagerForm initialSalesManagerData={null} />
                </div>
            </PageComponent>
        )
    }
    ...
    const { data: salesManager } = useSalesManager(salesManagerId)
        ...
        <PageComponent>
            <div className="w-full mb-4 p-6 flex flex-row justify-between bg-white shadow-lg rounded-xl">
                ...
                <Typography variant="h5" color="black">
                    Editace - {salesManager.data?.fullName}
                </Typography>
                <Link href={`/sales-managers/${salesManager.data?.id}/stats`}>
                    <Button>
            ...
            <div className="mx-auto w-8/12">
                <SalesManagerForm initialSalesManagerData={salesManager.data} />
            </div>
        </PageComponent>
    )
}
