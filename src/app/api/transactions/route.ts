import { addTransaction, getQuarterPointsByAccountIdAndYear, getTransactionById, getTransactionsByAccountId, removeTransactionById } from "@/db/queries/transactions";
...
export async function GET(request: Request) {
  ...
  if (accountId && year && type === "quarter") {
    const transactions = await getQuarterPointsByAccountIdAndYear(Number(accountId), Number(year));
