...
export default function CustomerStatsView({
    initialCustomer,
    initialTransactions,
}: CustomerStatsViewProps) {
    ...
    const deleteTransaction = async (transactionId: number) => {
        const endpoint = `/api/transactions/${transactionId}?customerId=${customer.id}`
    ...
    return (
        <>
            <div className="flex gap-8 my-2">
                <CustomerCard customer={customer} isLoading={isLoading} />
                <AccountInfoCard
                    account={account}
